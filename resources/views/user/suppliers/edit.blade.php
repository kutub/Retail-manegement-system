...
@section('content')
  <div class="flex-container">
    ...
    <form action="{{route('supplier.update', [app()->getLocale(), $supplier->id])}}" method="POST">
      {{method_field('PUT')}}
      {{csrf_field()}}
      ...
      <div class="field is-horizontal">
        ...
        <div class="field-body">
          <div class="field">
            <div class="control">
              <textarea class="textarea" name="address" value="{{$supplier->address}}">{{$supplier->address}}</textarea>
            </div>
          </div>
        </div>
      </div>
