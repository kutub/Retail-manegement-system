...
@section('content')
    <div class="flex-container">
      <div class="columns m-t-10">
        <div class="column">
          <h1 class="title">Manage Cash Expenses</h1>
        </div>
        <div class="column">
          <a href="{{route('expense.create', app()->getLocale())}}" class="button is-primary is-pulled-right"><i class="fa fa-user-plus m-r-10"></i> New Expense</a>
        </div>
      </div>
      <hr class="m-t-0">
