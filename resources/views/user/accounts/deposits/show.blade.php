                    ...
                    <div class="card-content">
                        ...
                        <div class="columns" style="padding:0 12px;">
                            <div class="column " style="border-width:1px;border-style:dashed;padding:20px">
                                <p style="line-height:2em;font-size:1.1em">Payment Received with thanks from Mr/Mrs <strong>{{$receive->customer}}</strong> by <strong>{{$receive->pay_by}}</strong> the amount of 
