    ...
    <section>
        <div class="card m-t-15">
            <header class="card-header" style="background-color:#00d1b2">
                <h1 style="color:#fff; font-size:20px" class="card-header-title has-text-centered">Edit Item</h1>
            </header>
                                ...
                                <template>
                                    <section>
                                        <div class="field is-horizontal">
                                            ...
                                            <div class="field-body">
                                                 <b-field label="Cost Price (Without Tax)" type="is-danger">
                                                    <b-input type="text" v-if="fields.price.cost_price" v-model="fields.price.cost_price" autofocus required></b-input>
                                                </b-field>
                                                <b-field label="Selling Price" type="is-danger">
                                                    <b-input type="text" v-model="fields.price.selling_price" required></b-input>
                                                </b-field>
                                            </div>
                                        </div>
           
                                        <b-field label="Promo Price">
                                            <b-input type="text" v-model="fields.price.promo_price" ></b-input>
                                        </b-field>
                                        ...
                                        <div class="block m-t-30">
                                            <b-checkbox  v-model="fields.price.include_tax">
                                                Prices Include Tax
                                            </b-checkbox>
                                            <b-checkbox class="m-l-10" v-model="fields.price.change_price">
                                                Change Cost Price During Sale
                                            </b-checkbox>
                                            <b-checkbox class="m-l-10" v-model="fields.price.override_commission">
                                                Override Default Commission
                                            </b-checkbox>
                                            <b-checkbox class="m-l-10" v-model="fields.price.override_tax">
                                ...
                                <template>
                                    <section>
                                        <b-field horizontal label="Reorder Level:">
                                            <b-input v-model="fields.quantity.reorder_level" placeholder="Reorder Level" type="text"></b-input>
                                        </b-field>

                                        <b-field horizontal label="Replenish Level:">
                                            <b-input v-model="fields.quantity.replenish_level" placeholder="Replenish Level" type="text"></b-input>
                                        </b-field>

                                        <b-field horizontal label="Days To Expiration:">
                                            <b-datepicker
                                                placeholder="Click to select..."
                                                v-model="fields.quantity.expiration_date"
                                                editable>
                                            </b-datepicker>
                                        </b-field>
                                        ...
                                        <b-field horizontal label="Current Quantity:" type="is-danger">
                                            <b-input placeholder="Quantity"
                                                type="text" v-model="fields.quantity.quantity">
                                            </b-input>
                                        </b-field>
                                        ...
                                        <b-field  horizontal label="Inventory To Add/Subtract:">
                                            ...
                                            type="text"
                                            v-model="fields.quantity.inventory_add_subs"
                                            >
                                            </b-input>
                                        </b-field>
                                        ...
                                        <b-field horizontal label="Comments:">
                                            <b-input type="textarea"
                                                maxlength="200"
                                                v-model="fields.quantity.comments"
                                ...
                                <template>
                                    <section>
                                        <figure class="image is-128x128 has-text-centered">
                                            <img :src="'/storage/images/products/'+fields.image.image">
                                        </figure>
                                ...
                                <template>
                                    <section>
                                        <b-field horizontal label="Location At Store:">
                                            <b-input v-model="fields.location.at_store" placeholder="Location At Store" type="text"></b-input>
                                        </b-field>

                                        <b-field horizontal label="Reorder Level:">
                                            <b-input v-model="fields.location.reorder_level" placeholder="Reorder Level" type="text"></b-input>
                                        </b-field>

                                        <b-field horizontal label="Replenish Level:">
                                            <b-input v-model="fields.location.replenish_level" placeholder="Replenish Level" type="text"></b-input>
                                        </b-field>
                                        <b-field horizontal label="Override Prices:">
                                             <b-checkbox v-model="fields.location.override_prices"></b-checkbox>
                                        </b-field>
                                        <b-field horizontal label="Override Default Tax:">
                                             <b-checkbox v-model="fields.location.override_tax"></b-checkbox>
                                        </b-field>
                                    </section>
                                </template>
    ...
    export default {
        ...
        created(){
            if(location.href.split('=')[1]){
                this.dynamicStep = Number(location.href.split('=')[1]);
                this.activeStep = this.dynamicStep;
            }
            ...
            axios.get(`/api/edit/${this.id}`)
                .then((response) => {
                    ...
                    this.fields.price == null  ? this.fields.price = {} : this.fields.price = this.fields.price;
                    console.log(this.fields);
                    this.fields.location == null  ? this.fields.location = {} : this.fields.location;
        ...
        methods: {
            ...
            checkUniqe(data, model){
                ...
                if (files.length > 0 && files[0].filename) {
                    this.fields.image.image = files[0].filename;
                }
                const loadingComponent = this.$buefy.loading.open({
                    container: this.isFullPage ? null : this.$refs.element.$el
                })
            ...
            onSkip(){
                if (this.activeStep == 5) {
                    ...
                    this.dynamicStep = this.activeStep;
                }
            }
        }
    }
